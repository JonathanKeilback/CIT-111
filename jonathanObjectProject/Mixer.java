...
public class Mixer {
    ...
    /**
     * MAIN METHOD - Greets the user, provides switching for operating the mixer.
     * @param args
    ...
    /**
     *This method makes the user choose how many channels they want to control.
     */
    ...
    /**
     *This method has the user name each channel.
     */
    public static void nameChannels() {
    ...
    /**
     *This method displays a graphical representation of the fader level,
     * and lists the aux levels too.
     */
    ...
    /**
     *This method shows a graphic representation of the aux levels requested
     * by the user.
     */
    public static void displayAux() {
    ...
    /**
     *This method changes levels for any fader/volume control.
     */
    public static void changeLevel() {
        ...
        validInput = false;
        if (channelChoice == 0) { //special prompt if the user wants to change the main output.
        ...
        } else { //For all regular channels, the user can adjust either the main output for aux.
